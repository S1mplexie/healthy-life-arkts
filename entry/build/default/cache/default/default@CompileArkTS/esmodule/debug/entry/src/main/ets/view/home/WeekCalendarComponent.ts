...
import WeekCalendarMethods from "@normalized:N&&&entry/src/main/ets/viewmodel/CalendarViewModel&";
import type { ScrollTo } from "@normalized:N&&&entry/src/main/ets/viewmodel/CalendarViewModel&";
...
import { sameDate } from "@normalized:N&&&entry/src/main/ets/common/utils/Utils&";
...
export class WeekCalendar extends ViewPU {
    ...
    initialRender() {
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new HealthText(this, { title: this.homeStore.dateTitle, fontSize: { "id": 16777306, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/home/WeekCalendarComponent.ets", line: 82, col: 11 });
