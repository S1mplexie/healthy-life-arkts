...
import { WeekCalendar } from "@normalized:N&&&entry/src/main/ets/view/home/WeekCalendarComponent&";
...
export default class HomeTopView extends ViewPU {
    ...
    initialRender() {
        ...
        }, Row);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/home/HomeTopComponent.ets", line: 40, col: 9 });
        ...
        Row.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new WeekCalendar(this, { homeStore: this.__homeStore }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/home/HomeTopComponent.ets", line: 54, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
