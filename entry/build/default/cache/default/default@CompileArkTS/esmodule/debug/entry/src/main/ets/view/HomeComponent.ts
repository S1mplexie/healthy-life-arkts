...
import HealthText from "@normalized:N&&&entry/src/main/ets/view/HealthTextComponent&";
import AddBtn from "@normalized:N&&&entry/src/main/ets/view/home/AddBtnComponent&";
import { TaskCard } from "@normalized:N&&&entry/src/main/ets/view/home/TaskCardComponent&";
import HomeTopView from "@normalized:N&&&entry/src/main/ets/view/home/HomeTopComponent&";
import { CustomDialogView } from "@normalized:N&&&entry/src/main/ets/view/dialog/CustomDialogView&";
import type { CustomDialogCallback } from "@normalized:N&&&entry/src/main/ets/view/dialog/CustomDialogView&";
import type TaskInfo from '../viewmodel/TaskInfo';
import type { HomeStore } from '../viewmodel/HomeViewModel';
import { TaskMapById } from "@normalized:N&&&entry/src/main/ets/model/TaskInitList&";
import type { ITaskItem } from "@normalized:N&&&entry/src/main/ets/model/TaskInitList&";
import { HealthDataSrcMgr } from "@normalized:N&&&entry/src/main/ets/common/utils/HealthDataSrcMgr&";
import { BroadCastType } from "@normalized:N&&&entry/src/main/ets/common/utils/BroadCast&";
import type { BroadCast } from "@normalized:N&&&entry/src/main/ets/common/utils/BroadCast&";
...
export default class HomeIndex extends ViewPU {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new HomeTopView(this, { homeStore: this.__homeStore }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/HomeComponent.ets", line: 124, col: 11 });
            ...
            if (this.homeStore.getTaskListOfDay().length > 0) {
                            ...
                            }, __Common__);
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                                        ...
                                        }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/HomeComponent.ets", line: 129, col: 17 });
                                        ViewPU.create(componentCall);
                                        let paramsLambda = () => {
                                            return {
                                                taskInfoStr: JSON.stringify(item),
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new HealthText(this, { title: '', titleResource: { "id": 16777245, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }, fontSize: { "id": 16777306, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/HomeComponent.ets", line: 151, col: 15 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        title: '',
        ...
        Scroll.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new AddBtn(this, { clickAction: () => {
                            this.editTaskAction();
                        } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/HomeComponent.ets", line: 165, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            clickAction: () => {
        ...
        Row.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new CustomDialogView(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/HomeComponent.ets", line: 179, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {};
                    };
