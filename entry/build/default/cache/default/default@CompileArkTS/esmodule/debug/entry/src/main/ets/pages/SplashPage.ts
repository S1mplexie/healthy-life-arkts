...
import UserPrivacyDialog from "@normalized:N&&&entry/src/main/ets/view/dialog/UserPrivacyDialog&";
    ...
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.dialogController = new CustomDialogController({
            builder: () => {
                ...
                }, undefined, -1, () => { }, { page: "entry/src/main/ets/pages/SplashPage.ets", line: 33, col: 14 });
