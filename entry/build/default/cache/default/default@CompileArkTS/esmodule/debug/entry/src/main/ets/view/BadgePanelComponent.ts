...
import { BadgeCard } from "@normalized:N&&&entry/src/main/ets/view/BadgeCardComponent&";
import { getAchievementLevel } from "@normalized:N&&&entry/src/main/ets/model/AchieveModel&";
import { getBadgeCardItems } from "@normalized:N&&&entry/src/main/ets/viewmodel/AchievementViewModel&";
import Logger from "@normalized:N&&&entry/src/main/ets/common/utils/Logger&";
import { ACHIEVEMENT_LEVEL_KEY } from "@normalized:N&&&entry/src/main/ets/model/AchieveModel&";
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new BadgeCard(this, { content: item.titleContent, imgSrc: item.achievement }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/BadgePanelComponent.ets", line: 36, col: 9 });
