...
import { AchievementDialog } from "@normalized:N&&&entry/src/main/ets/view/dialog/AchievementDialog&";
import { TaskDetailDialog } from "@normalized:N&&&entry/src/main/ets/view/dialog/TaskDetailDialog&";
...
import { TaskItem } from "@normalized:N&&&entry/src/main/ets/model/TaskInitList&";
...
export class CustomDialogView extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.achievementDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new AchievementDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/CustomDialogView.ets", line: 38, col: 14 });
