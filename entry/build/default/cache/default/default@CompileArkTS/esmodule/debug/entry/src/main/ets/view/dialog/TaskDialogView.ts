...
import { TargetSettingDialog, RemindTimeDialog, FrequencyDialog } from "@normalized:N&&&entry/src/main/ets/view/dialog/TaskSettingDialog&";
...
export class TaskDialogView extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.targetSettingDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new TargetSettingDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/TaskDialogView.ets", line: 33, col: 14 });
        ...
        this.RemindTimeDialogController = new CustomDialogController({
            builder: () => {
                let jsDialog = new RemindTimeDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/TaskDialogView.ets", line: 40, col: 14 });
                jsDialog.setController(this.
                // remind time dialog
        ...
        this.FrequencyDialogController = new CustomDialogController({
            builder: () => {
                let jsDialog = new FrequencyDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/TaskDialogView.ets", line: 47, col: 14 });
                jsDialog.setController(this.
                // frequency dialog
